const depoimentos = [
  {
    ...
    estrelas: 5,
    texto: "Passei na primeira tentativa! Estudei 15 minutos por dia durante 3 semanas no ônibus pro trabalho. As questões cobrem todos os temas que caíram na minha prova. Recomendo demais.",
  ...
  },
  {
    ...
    estrelas: 5,
    texto: "Perfeito pra quem não tem tempo. Fiz no intervalo do almoço durante 2 semanas e passei com folga. O simulado completo prepara muito bem pro formato da prova do DETRAN-RJ.",
